...
# data
This folder contains the raw output of the analysis tools. All of the data is broken down into separate files for each company included in the study and split between tweets sent from the company and tweets sent to the company.
...
- types - contains word and emoji frequency information for each company
...
- find_conc_html.py - as above with HTML output
